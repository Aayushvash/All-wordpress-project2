					...
					<div class="centring">
                    	...
                    	<div class="rightbox right">
                            ...
                            <div class="resquest">
                                ...
                                <img src="<?php bloginfo('template_url'); ?>/images/message-direct@2x.png" alt="" width="32" height="27" />
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('onzeklaten_right_sidebar') ) : ?> <?php endif; ?>
