...
if ($_SERVER['REQUEST_METHOD']=='POST') {	
	if(isset($_POST['carttotal']) && is_numeric($_POST['carttotal'])) {
		...
		$mailer->addBCC(get_option('admin_email'));
...
?>	
	...
	<?php for($i=1; $i<=2; $i++){  ?>
        ...
        <article class="sandwich-block  <?php echo (($i==2)?'ordersand':''); ?>">
			...
			<aside class="link" style="<?php if($i == 2) { echo 'margin-bottom:50px;'; } ?>">
            ...
            <div class="post" id="post-<?php the_ID(); ?>">            
				...
				<tr>
					...
					<td>
					<div class="carttotalshortview" style="text-align:right;padding-right:8px;"></div>
					<input type="submit" class="submitbtn" name="btnSubmit" value="Checkout" style="margin-top:10px;"  onclick="return bis()" />
					</td>
				</tr>
				</table>
