...
<!--  \ wrapper / -->		
		...
		jQuery(document).ready(function(){
			...
			jQuery('#addressbottom .subscribeBar h2.widgettitle').append('<div class="subText"></div>');
			jQuery('#addressbottom .subscribeBar h2.widgettitle .subText').html('Subscribe to our newsletter and get exclusive deals you wont find anywhere else straight to your inbox!');
		
		if(jQuery(window).width()>767){
			
			var h = jQuery('.singleBox').height();
			jQuery('.singleBox .singleLeft').height(h);
