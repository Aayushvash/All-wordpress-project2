<?php 
/***
 This is Main class For TeamCategories.
***/
...
class TeamCategories
{
    ...
    {
	   global $wpdb;
	   $this->tablename = $wpdb->prefix."team_category";
	...
	public function getCategories($id='',$search='')
	{
		...
		if($id)
		 $query .= " AND id=$id";
		if($search)
		 $query .= " AND (name LIKE '%".$search."%' OR descr LIKE '%".$search."%')";
		  
		$query .= " ORDER By catorder ASC"; 
	...
	public function addCategory($data)
	{
		...
		$data=array(
		  'name'=> $data['category'],
		  'descr' => $data['categorydesc'],
		  'catorder'=> $data['categoryorder'],
		  'status' => $status,
		  'date' => $date
		);
		...
		if($id)
		{
			...
			$result['redirect'] = 'admin.php?page=shepley_team_categories&message=inserted&status=success'; 
		}
		else
		{
			$result['status'] = 'error';
			$result['redirect'] = 'admin.php?page=shepley_team_categories&message=inserterror&status=error'; 
		}
	...
	public function editCategory($data)
	{
		...
		{
			$result['status'] = 'success';
			$result['redirect'] = 'admin.php?page=shepley_team_categories&message=updated&status=success'; 
		}
		else
		{
			$result['status'] = 'error';
			$result['redirect'] = 'admin.php?page=shepley_team_categories&message=updateerror&status=error'; 
		}
	...
	public function deleteCategory($data)
	{
		...
		{
			$result['status'] = 'success';
			$result['redirect'] = 'admin.php?page=shepley_team_categories&message=deleted&status=success'; 
		}
		else
		{
			$result['status'] = 'error';
			$result['redirect'] = 'admin.php?page=shepley_team_categories&message=deleteerror&status=error'; 
		}
