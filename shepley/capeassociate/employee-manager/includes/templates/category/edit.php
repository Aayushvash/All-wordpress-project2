...
$(document).ready(function() {
    $('#edit_category').click(function(){
		...
		var url="<?php echo WP_PLUGIN_URL; ?>/employee-manager/includes/ajax_emp_categories.php?action=editcat&category="+category+"&categorydesc="+categorydesc+"&categoryorder="+categoryorder+"&category_id="+category_id;
...
<input type="hidden" name="category_id" id="category_id" value="<?php echo $this->categories[0]->id; ?>"/>
 <table class="form-table">
		...
		<tr class="form-field">
			...
			<td>
	<textarea class="large-text" cols="50" rows="5" id="category-description" name="category-description"><?php echo $this->categories[0]->description; ?></textarea>
			<br>
        ...
        <tr class="form-field">
			...
			<td>
	        <input type="text" aria-required="true" size="20" value="<?php echo $this->categories[0]->cat_order; ?>" id="category-order" name="categoy-order">
			<br>
			<span class="description">This order set the sorting order.</span></td>
		</tr>
			</tbody>
			</table>
	<p class="submit"><input type="submit" value="Update" class="button-primary" id="edit_category" name="edit_category"><span id="ajax_call" style="padding:5px;display:none;float:left;"><img src="<?php echo WP_PLUGIN_URL;?>/employee-manager/images/wpspin_light.gif"/></span></p>
</div>