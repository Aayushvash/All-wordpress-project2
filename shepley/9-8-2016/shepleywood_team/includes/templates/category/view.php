...
$(document).ready(function() { 
    ...
    $('#add_categoy').click(function(){
		...
		var url="<?php echo WP_PLUGIN_URL; ?>/shepleywood_team/includes/ajax_team_categories.php?action=addnew&category="+category+"&categorydesc="+categorydesc+"&categoryorder="+categoryorder;
    ...
    $('#delete_category').click(function(){
		...
		var url="<?php echo WP_PLUGIN_URL; ?>/shepleywood_team/includes/ajax_team_categories.php?action="+action+"&ids="+ids;
...
<div class="wrap">
 ...
 <h2>Manage Categories</h2>
    <form action="admin.php?page=shepley_team_categories&action=search" method="post">
	<p class="search-box">
...
<table cellspacing="0" class="wp-list-table widefat fixed tags">
	...
	<tbody class="list:tag" id="the-list">
		...
		<strong>
		<a title="<?php echo $region->name; ?>" href="admin.php?page=shepley_team_categories&action=edit&catid=<?php echo $category->id; ?>" class="row-title">
		...
		<div class="row-actions">
			...
			<a title="Edit this item" href="admin.php?page=shepley_team_categories&action=edit&catid=<?php echo $category->id; ?>">Edit</a> | </span>

			<span class="trash">

			<a href="admin.php?page=shepley_team_categories&action=delete&catid=<?php echo $category->id; ?>" onclick="return check_confirm();" title="Move this item to the Trash" class="submitdelete">
