...
<?php get_header(); ?>
	...
	<section id="content" role="main" class="clearfix animated">
		...
		<div class="owl-carousel">				
		 <?php	query_posts(array('post_type'=>'vendorsvenues', 'orderby'=> 'title', 'order' => 'ASC',  'taxonomy' => 'vvcategories', 'showposts' => -1,'field' => 'slug','term'=>$tax_term->slug ));  if(have_posts()):while(have_posts()):the_post(); 
		 ...
		 <div class="item">
			...
			<?php endwhile; endif;  ?>
				...
				<div class="list-block">
					<?php  
						query_posts(array('post_type'=>'vendorsvenues', 'orderby'=> 'title', 'order' => 'ASC',  'taxonomy' => 'vvcategories', 'showposts' => -1,'field' => 'slug','term'=>$tax_term->slug ));  if(have_posts()):while(have_posts()):the_post(); 
						$check = get_field('enhances_listings'); 
							?>
					<div class="grid-4 " style="<?php if($check[0]=='List') { echo 'display:none;';  } ?>" > 
					
					<h2><a target="_blank" href="<?php the_field('website'); ?>"><?php the_title(); ?></a></h2> 
					</div>
