$('.ger-bar.ger-barp .box').appear();
$(document.body).on('appear', '.ger-bar.ger-barp .box', function(e) {
...
$(document).ready(function () {
	...
	$(".nor .left").hover(function () {
		//alert("hello");
        $('.nor .left .show').toggleClass('sh');

    });
	$('.nor .box2').hover(function(){
		$('.nor .box2 .show').toggleClass('sh');
	});
	
	$('.nor .box1').hover(function(){
		$('.nor .box1 .show').toggleClass('sh');
	});
	$('.nor .right .bottom').hover(function(){
		$('.nor .right .bottom .show').toggleClass('sh');
	});
	$('.nor .right .top').hover(function(){
		$('.nor .right .top .show').toggleClass('sh');
	});
