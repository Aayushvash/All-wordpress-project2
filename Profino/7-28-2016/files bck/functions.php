...
add_image_size( 'post-small', 274, 160, true );
add_image_size( 'post-medium', 410, 239, true );
add_image_size( 'post-large', 543, 323, true );
add_image_size( 'bootm-large', 412, 161, true );
add_image_size( 'top-large', 550, 323, true );
add_image_size( 'side-large', 274, 94, true );
