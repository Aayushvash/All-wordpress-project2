...
<div id="center-part"> 
    ...
    <div class="all-bar all-barp  scrollme" >
        <div class="cantain">
            <div class="left">
	...
	<div style="display:none;" class="all-bar all-barp  mobile" >
		<div class="image">
			<img src="<?php bloginfo('template_url');?>/images/bg1m.png" / >
		</div>
        <div class="cantain">
            <div class="right">
				<h2 class="mobile-head">
					<?php the_field('wird_leichter_left') ?>
				</h2>
    ...
    <div class="rund-bar"  id="two">
        <div class="centering">
            ...
            <div class="video">
                <div class="left"> 
					<img src="<?php the_field('rundgang_top'); ?>" alt="" /> 
					<a class="various fancybox.iframe" id="video" href="<?php the_field('rundgang_video_url'); ?>?autoplay=1">
    ...
    <div class="wird-bar wird-barp scrollme">
        <div class="cantain">
            <div class="left">
	...
	<div style="display:none;" class="wird-bar wird-barp mobile">
        <div class="cantain"> 
			<div class="image">
				<img src="<?php bloginfo('template_url');?>/images/bg2m.png" / >
			</div>
            <div class="right">
			<h2 class="mobile-head">
							<?php the_field('wird_leichter_left_content') ?>
            ...
            <div class="nor">
                ...
                while ($loop->have_posts()) : $loop->the_post();
                    ...
                    <div class="left">
                        ...
                        <?php the_post_thumbnail('top-large'); ?>
						<div class="title1">
                        <h3>
                        ...
                        <div class="overlay1 show">
                            ...
                            <p class="cnt"><?php // echo substr(strip_tags($loop->post_content), 0, 70);  ?>
                                <span>
									<?php $content = get_field('teaser');
											//$content = strip_tags($content);
											$content1 = substr($content, 0, 1000);
											if($content1){
												echo $content1;
												echo '...<span class="mehr">mehr</span>';
											}?>
						...
						<a href="<?php the_permalink(); ?>">
							...
							<div class="overlay1 show">
								...
								<p><span>
									<?php $content = get_field('teaser');
											//$content = strip_tags($content);
											$content1 = substr($content, 0, 500);
											if($content1){
												echo $content1;
												echo '...<span class="mehr">mehr</span>';
											} ?>
								<?php //the_field('teaser');//echo substr(strip_tags($post->post_content), 0, 70); ?></span></p>
							</div>
						</a>
						</div>
                    </div>
                            ...
                            if (have_posts()) : while (have_posts()) : the_post();
                                    ...
                                    <div class="title">
                                        ...
                                        <div class="right">
                                            ...
                                            <p class="show"><?php echo strip_tags(get_the_content()); ?><a href="<?php the_field('link_url'); ?>" class="link"><?php the_field('link_text'); ?></a></p>
