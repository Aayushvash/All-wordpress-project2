...
<div id="wrapper">
	...
	<div id="layout">
		...
		<div id="content">
			...
			<!--  / center side\ -->
			<div id="centerSide" class="withnewsidebar">
                    	...
                    	<li>
                           ...
                           <?php
                            ...
                            <div class="center">
								...
								<h3><a href="<?php echo $mainPath.HtAccessURL('inventory',$info['Make'].':'.$info['Model'].':'.$info['BoatID']);?>" />Click for Pricing</a>
