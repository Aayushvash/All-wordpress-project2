		...
		<div class="left">
			<div class="rental">
				...
				<ul>
					...
					<li class="renT"><span>Rental Time:</span><cite><?php if($time=="1pm-5pm"){ echo "1pm-5pm"; }elseif($time=="9am-5pm"){ echo "9am-5pm"; }else { echo "10am-2pm";;}  ?></cite></li>
					<li class="retD"><span>Return Date:</span><cite><?php echo $date; ?></cite></li>
					<li class="retT"><span>Return Time:</span><cite><?php if($time=="1pm-5pm"){ echo "1pm-5pm"; }elseif($time=="9am-5pm"){ echo "9am-5pm"; }else { echo "10am-2pm";;}  ?></cite></li>
				</ul>
			</div>
			<div class="clear"></div>
			<div class="grtandBock">
				<ul>
					<li>Rental Amount:<span class="price"><?php if($time=="1pm-5pm"){ the_field('afternoon'); }elseif($time=="9am-5pm"){the_field('all_day');}else { the_field('4_hours');}  ?></span></li>
					...
					<li><strong>Grand Total:<span class="grandTotal"><?php if($time=="1pm-5pm"){ the_field('afternoon'); }elseif($time=="9am-5pm"){the_field('all_day');}else { the_field('4_hours');}  ?></span></strong></li>
				</ul>
			</div>
...
<div class="clear"></div>
	...
	<div class="checkBlock">
				...
				<div class="aright">
					<h2>Total</h2>
					<ul>
					   <li><span><?php the_title(); ?>:</span>$ <?php if($time=="Afternoon"){ the_field('afternoon'); }elseif($time=="AllDay"){the_field('all_day');}else { the_field('4_hours');}  ?></li>
					</ul>
					<div class="total">$<span class="totlePrice"><?php if($time=="Afternoon"){ the_field('afternoon'); }elseif($time=="AllDay"){the_field('all_day');}else { the_field('4_hours');}  ?></span></div>
...
jQuery(window).load(function(){
	...
	jQuery('.accessoriesBlock ul li').each(function(){
	...
	jQuery('.damageBlock ul li').each(function(){
		jQuery(this).click(function(){
			jQuery(this).toggleClass('active');
			if(jQuery(this).attr('class')=="active"){
