				 ...
				 $k=1; $i=1;
                	...
                	<div class="text">
						<div class="data">
							...
							<div class="menus">	
							<ul>
<?php	query_posts(array('post_type'=>'stratos', 'orderby' => 'term_order', 'order' => 'ASC',  'taxonomy' => 'stratos_category', 'showposts' => -1,'field' => 'slug','term'=>$tax_term->slug ));  if(have_posts()):while(have_posts()):the_post(); ?>	
