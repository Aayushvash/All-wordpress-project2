	...
	<!-- begin family block -->
				...
				wp_reset_query();
				 ...
				 $k=1; $i=1;
					...
					<div class="image">
					<?php $imgs = get_field('category_image'); ?>
					
					
					<img src="<?php  echo $imgs['sizes']['cat-thumb'];?>" />
					</div>
                	...
                	<div class="text">
						<div class="data">
							...
							<div class="menus">	
							<ul>
<?php	query_posts(array('post_type'=>'brandbrochure', 'orderby' => 'term_order', 'order' => 'ASC',  'taxonomy' => 'brand_category', 'showposts' => -1,'field' => 'slug','term'=>$tax_term->slug ));  if(have_posts()):while(have_posts()):the_post(); ?>	
