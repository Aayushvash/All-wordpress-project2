	...
	<div id="layout">
		...
		<div id="content">
			...
			<div id="centerSide">
                ...
                <option value="lengthdesc" <?php if (@$_REQUEST['sort'] == "lengthdesc") { echo "selected=\"selected\"";}?>>Length (low to high)</option>
                <option value="lengthasc" <?php if (@$_REQUEST['sort'] == "lengthasc") { echo "selected=\"selected\"";}?>>Length (high to low)</option>
