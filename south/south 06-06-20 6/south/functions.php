...
if ( function_exists('register_sidebar') ) {
	...
	register_sidebar(array(
		'name' => 'Rental Form Page',
		'id' => 'rental_form_sidebar',
		'description' => 'This area Rental Form Page',	
		'before_widget' => '<div id="%1$s" class="form-rental %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h1>',
		'after_title' => '</h1>',
	));
	...
	register_sidebar(array(
		'name' => 'Brand Logo Lowe Logo Sidebar',
		'id' => 'lowe_logo',
		'description' => 'This area brand page of Lowe Boats use image widget for this area',	
		'before_widget' => '<div id="%1$s" class="image %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h1>',
		'after_title' => '</h1>',
	...
	register_sidebar(array(
		'name' => 'Brand Logo Stratos Logo Sidebar',
		'id' => 'stratos_logo',
		'description' => 'This area brand page of Stratos Boats use image widget for this area',	
		'before_widget' => '<div id="%1$s" class="image %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h1>',
		'after_title' => '</h1>',
	...
	register_sidebar(array(
		'name' => 'Brand Logo Sylvan Logo Sidebar',
		'id' => 'sylvan_logo',
		'description' => 'This area brand page of Sylvan Boats use image widget for this area',	
		'before_widget' => '<div id="%1$s" class="image %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h1>',
		'after_title' => '</h1>',
	...
	register_sidebar(array(
		'name' => 'Brand Logo Sunchaser Logo Sidebar',
		'id' => 'sunchaser_logo',
		'description' => 'This area brand page of Sunchaser Boats use image widget for this area',	
		'before_widget' => '<div id="%1$s" class="image %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h1>',
		'after_title' => '</h1>',
...
add_image_size('team-thumb', 190, 142, true); 
add_image_size('big-thumb', 460, 670, true); 
add_image_size('rental-img', 360, 280, true); 
add_image_size('home-brand-img', 274, 173, true); 
...
$options = array (
	...
	array(	"name" => "No Inventory Form Text",

	"desc" => "Type No Inventory Form Text for Brouchure",
