		...
		<div id="header">
			<div class="bg-top">
				...
				<div class="centring">					
						...
						<a class="fb" target="_blank" href="<?php echo get_theme_option('face'); ?>"></a>
						<?php } ?>
						
						<?php if(get_theme_option('you')){ ?>
						<a class="you" target="_blank" href="<?php echo get_theme_option('you'); ?>"></a>
						<?php } ?>
