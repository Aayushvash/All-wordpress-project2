...
*/  $feat_image = wp_get_attachment_url( get_post_thumbnail_id($post->ID) );?>
	...
	<div id="banner-wrap" class="inner-brand">
		...
		<div class="bran-logo"><?php if ( is_active_sidebar( 'sunchaser_logo' ) ) : ?>

			<?php dynamic_sidebar( 'sunchaser_logo' ); ?>
				 ...
				 $k=1; $i=1;
                	...
                	<div class="text">
						<div class="data">
							...
							<div class="menus">	
							<ul>
<?php	query_posts(array('post_type'=>'sunchaser',  'taxonomy' => 'sunchaser_category', 'showposts' => -1,'field' => 'slug','term'=>$tax_term->slug ));  if(have_posts()):while(have_posts()):the_post(); ?>	
