...
<!-- finish  header --> 
	<div class="centring">
		...
		<div id="fullCntr">
			...
			<h1><?php the_title(); ?><span style="float:right"><a href="https://www1.oh.wildlifelicense.com/start.php" target="_blank"><img src="<?php $upload_dir = wp_upload_dir();echo $upload_dir['url']; ?>/fishinglicense.png"></a></span></h1>
