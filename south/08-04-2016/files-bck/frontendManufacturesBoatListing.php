...
/*if(isset($NewUsed) && $NewUsed!='')

{

	$_POST['NewUsed']=$NewUsed;
...
if (@$_POST['NewUsed'] && $_POST['NewUsed'] != ""){
	...
	$SearchMake = $_POST['NewUsed'];

	$Query.= " AND NewUsed ='$SearchMake' ";
		...
		<h4>Search boats for sale</h4>
            	...
            	<div class="option">
				  ...
				  <select name="location" id="Location">
						...
						/*$rsser1 = $_POST['NewUsed'];

						$rsser2 = $_POST['make'];

						$Querysearch = "SELECT DISTINCT LocationCity, LocationState FROM `".$table_prefix."bv_boatdetails` Where NewUsed ='$rsser1' and Make='$rsser2' AND Status='Active' ORDER BY LocationCity";
