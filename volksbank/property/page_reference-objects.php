<?php /*
Template Name: Referenzobjekte mit Sidebar
*
* @file           page-reference.php
 * @package       Property
...
query_posts( array( 'post_type' => 'portfolio', 'posts_per_page' => '8', 'paged' => $paged) ); 
if (have_posts()) :	while (have_posts()) : the_post(); ?>
<div class="col-ohc">
<div class="propbox" style="margin:0 15px 5px 0;">
