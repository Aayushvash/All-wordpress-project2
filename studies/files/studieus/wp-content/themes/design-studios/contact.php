					...
					<div class="centering">
						<div class="contact-form">
							...
							<div class="information">
								...
								<ul>
									<li><img src="<?php bloginfo('template_url');?>/images/informartion-img1.jpg" alt=""> <a href="tel:<?php echo of_get_option('phone_number');?>"><?php echo of_get_option('phone_number');?></a></li>
									
									<li><img src="<?php bloginfo('template_url');?>/images/informartion-img2.jpg" alt="">  <a href="mailto:<?php echo of_get_option('email_here');?>"><?php echo of_get_option('email_here');?></a></li>
									
									<li><img src="<?php bloginfo('template_url');?>/images/informartion-img3.jpg" alt="">  <?php echo nl2br(of_get_option('contact_us'));?></li>
